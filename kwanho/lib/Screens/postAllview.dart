...
class PostAllViewPage extends StatefulWidget {
  ...
  @override
  _PostAllViewPageState createState() => _PostAllViewPageState();
}
                ...
                if(index.isOdd) return Divider();
                  ...
                  subtitle: Column(
                    ...
                    Row(
                      ...
                      children: [
                        (state.postList[realIndex].category == "100")?
                        Text("Hot 게시판",style: TextStyle(fontSize: 14),)
                            : Text("${state.postList[realIndex].category}대 게시판",style: TextStyle(fontSize: 14),),
                        Row(
                          children: [
